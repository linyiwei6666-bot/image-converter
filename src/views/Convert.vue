...
const titleMap = {
  "jpg-to-png": "Convert JPG to PNG Online - Lossless & Privacy-First",
  "png-to-jpg": "Convert PNG to JPG Online - Optimized for Web Speed",
  "png-to-webp": "Convert PNG to WebP - Next-Gen Google Image Format",
  "webp-to-png": "Convert WebP to PNG - High Fidelity Compatibility",
  "jpg-to-webp": "Convert JPG to WebP - Ultimate SEO Optimization",
  "webp-to-jpg": "Convert WebP to JPG - Universal Format Conversion",
}

// 2. 深度长描述 (你原有的高质量文案)
const descriptionMap = {
  "jpg-to-png": "Looking to preserve image quality or add transparency? Our JPG to PNG converter is the perfect solution. While JPG uses lossy compression that can degrade quality over time, PNG (Portable Network Graphics) offers lossless compression, ensuring every pixel remains crisp. This conversion is essential for designers who need to remove backgrounds or work with logos and icons that require a transparent layer. By processing your files directly in your browser using Vue 3 technology, we ensure your data never leaves your device, providing 100% privacy and lightning-fast results.",
  "png-to-jpg": "Need to reduce your image file size for faster web loading? Converting PNG to JPG is one of the most effective ways to optimize digital photos. PNG files are often unnecessarily large for standard photography. By switching to JPG (Joint Photographic Experts Group), you can significantly decrease the file footprint without noticeable loss in visual quality. This is ideal for bloggers, social media managers, and web developers aiming to improve their site's Core Web Vitals and SEO performance. Our tool handles the compression locally, so you don't have to worry about bandwidth or data security.",
  "png-to-webp": "Take your website's performance to the next level by converting PNG to WebP. WebP is a modern, next-generation image format developed by Google that provides superior lossless and lossy compression. On average, WebP images are 26% smaller than PNGs while maintaining the same high-quality transparency. This conversion is a 'must-have' for modern SEO, as smaller image files lead to faster PageSpeed scores. Whether you are building a professional portfolio or an e-commerce store, our browser-based converter makes it easy to adopt the latest web standards instantly without any software installation.",
  "webp-to-png": "Encountering compatibility issues with WebP files? While WebP is great for the web, many older image editors, operating systems, and professional printing services still don't fully support it. Converting WebP back to PNG allows you to regain full editability and lossless quality. This is especially useful for graphic designers who need to import web assets into software like older versions of Photoshop or Illustrator. Our tool ensures that the conversion process remains high-fidelity, giving you a clean, uncompressed PNG file ready for any professional project.",
  "jpg-to-webp": "Upgrade your image library with our JPG to WebP converter. As Google continues to prioritize mobile-first indexing and fast loading speeds, switching your standard JPG photos to the modern WebP format is a smart SEO move. WebP offers 25-34% smaller file sizes compared to equivalent JPG images, meaning your pages will load faster and consume less data for your users. Our tool utilizes the power of your browser's local processing to handle the conversion, meaning no waiting for server uploads and no risk to your personal photo privacy.",
  "webp-to-jpg": "The most universal way to share your photos is by converting WebP to JPG. While WebP is efficient, it can sometimes be a headache when trying to upload images to certain social media platforms, online forms, or viewing them on older mobile devices. JPG remains the world's most compatible image format. By using our converter, you can quickly transform any WebP file into a standard JPG that works everywhere—from email attachments to digital photo frames. Best of all, you can adjust the quality settings during conversion to find the perfect balance between file size and visual clarity."
}
